  ...
  if (main.villain === "Assasins") {
    ...
    if (vs.weapon === "Attack") {
      ...
      if (again.weapon === "Attack") {
        ...
        if (villainFuel <= 0) {
          console.log(
            chalk.green(main.hero) + " used Batarang Again and hit the " +chalk.red(main.villain) 
          );
        ...
        if ((secondAgain.weapon === "y", "Y", "YES", "yes")) {
          ...
          if (villainFuel <= 0) {
            console.log(
              main.hero + " used Batarang Again and hit the " + chalk.red(main.villain)
            );
    ...
    if (main.villain === "Assasins") {
      ...
      if (vs.weapon === "Attack") {
        ...
        if (again.weapon === "Attack") {
            ...
            console.log(
              chalk.green(main.hero) + " used Laser Light Again and hit the " + chalk.red( main.villain)
            );
            console.log(`${chalk.red( main.villain)}'s fuel remaining is ${chalk.bgRed("0")}`);
