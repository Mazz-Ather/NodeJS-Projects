...
if (main.hero === "Batman") {
  if (main.villain === "Assasins") {
    ...
    if (vs.weapon === "Attack") {
      ...
      console.log(
        chalk.red(main.villain) +
          `'s also hit you , ${chalk.green(
            main.hero
          )}'s remaining fuel is ${chalk.bgGreen((batmanfuel -= 30))}`
      );
      ...
      if (again.weapon === "Attack") {
        ...
        if (villainFuel <= 0) {
          ...
          console.log(
            `${chalk.red(main.villain)}'s fuel remaining is ${chalk.bgGreen(
              (batmanfuel = 100)
            )}`
          );
        ...
        batmanfuel = 100;
        console.log(
          `${chalk.green(main.hero)}'s fuel now is ${chalk.bgGreen(
            (batmanfuel = 100)
          )}`
        );
        ...
        if ((secondAgain.weapon === "y", "Y", "YES", "yes")) {
          ...
          if (villainFuel <= 0) {
            ...
            console.log(
              `${chalk.red(main.villain)}'s fuel remaining is ${chalk.red("0")}`
            );
            console.log("Congratulation " + chalk.green(main.hero) + " won!");
            process.exit();
          }
    ...
    console.log(
      chalk.red("Friendly Disclaimer: As a Batman you cannot fight with Robot")
    );
    ...
    if (vs.weapon === "Attack") {
      ...
      console.log(
        main.villain + `'s fuel remaining ${chalk.bgRed((villainFuel -= 10))}`
      );
      console.log(
        chalk.red(main.villain) +
          `'s also hit you , ${chalk.green(
            main.hero
          )}'s remaining fuel is ${chalk.bgGreen((herofuel -= 98))}`
      );
      ...
      if (again.weapon === "Attack") {
        ...
        console.log(
          `${chalk.red(main.villain)}'s fuel remaining is ${chalk.bgRed("80")}`
        );
        console.log(
          chalk.green(main.hero) + "'s fuel is " + chalk.bgGreen("0")
        );
        ...
        if ((secondAgain.weapon === "y", "Y", "YES", "yes")) {
          ...
          console.log(
            `${chalk.red(main.villain)}'s fuel remaining is ${chalk.red("70")}`
          );
    ...
    if (vs.weapon === "Attack") {
      ...
      console.log(
        chalk.red(main.villain) +
          `'s also hit you , ${chalk.green(
            main.hero
          )}'s remaining fuel is ${chalk.bgGreen((supfuel -= 30))}`
      );
      ...
      if (again.weapon === "Attack") {
        ...
        if (villainFuel <= 0) {
          ...
          console.log(
            `${chalk.red(main.villain)}'s fuel remaining is ${chalk.bgRed("0")}`
          );
          console.log("Congratulation " + chalk.green(main.hero) + " won!");
          process.exit();
        }
    ...
    if (vs.weapon === "Attack") {
      ...
      console.log(
        chalk.red(main.villain) +
          `'s also hit you , ${chalk.green(
            main.hero
          )}'s remaining fuel is ${chalk.bgGreen("90")}`
      );
      ...
      if (again.weapon === "Attack") {
        ...
        console.log(
          chalk.green(main.hero) + "'s fuel is " + chalk.bgGreen(" 90")
        );

        console.log(
          "Congratulations " + chalk.green(main.hero) + chalk.red(" you Win!")
        );
        process.exit();
        // }
      } else if (vs.weapon === "Give up") {
        ...
        herofuel = 100;
        console.log(
          `${chalk.green(main.hero)}'s fuel now is ${chalk.bgGreen("100")}`
        );
        ...
        if ((secondAgain.weapon === "y", "Y", "YES", "yes")) {
          ...
          console.log(
            chalk.green(main.hero) + "'s fuel is" + chalk.bgGreen("100")
          );

          console.log(
            "Congratulations" + chalk.green(main.hero) + chalk.green(" win!!!")
          );
          process.exit();
        }
      }
